...
<head>
    ...
    <meta name="title" content="新北市觀光工廠簡介">
    <meta name="description" content="新北市觀光工廠簡介">

    <meta property="og:type" content="website">
    <meta property="og:url" content="">
    <meta property="og:title" content="新北市觀光工廠簡介">
    <meta property="og:description" content="新北市觀光工廠簡介">
    <meta property="og:image" content="./img/bg.jpg">

    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="">
    <meta property="twitter:title" content="新北市觀光工廠簡介">
    <meta property="twitter:description" content="新北市觀光工廠簡介">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <div class="container">
            <h3><span class="navbar-brand text-light font-weight-bold">新北市觀光工廠簡介</span></h3>
    ...
    <div class="container" id="content">
        <div class="row wow fadeInUp">
            <div class="col-12 my-3">
                <h1 class="text-center text-white">簡介</h1>
                <hr class="bg-white">
            </div>
            <table>
                <div class="col-12 col-md-6 col-lg-3 my-3 ">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac1.jpg" class="card-img-top object-fit" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac2.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac3.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning">
                        <img src="./img/fac4.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac5.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac6.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac7.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac8.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac9.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac10.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac11.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac12.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac13.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac14.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac15.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac16.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac17.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac18.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac19.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac20.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac21.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                    <div class="card w-100 h-100 text-white bg-dark border-warning ">
                        <img src="./img/fac22.jpg" class="card-img-top object-fit mw-100" alt="...">
                        <div class="card-body">
